package org.dalvarez.shop.core.article_category.infrastructure.rest_api.controller.get.by_id;

import org.dalvarez.shop.core.article_category.application.ArticleCategoryResponse;
import org.dalvarez.shop.core.article_category.application.find.by_id.ArticleCategoryByIdFinder;
